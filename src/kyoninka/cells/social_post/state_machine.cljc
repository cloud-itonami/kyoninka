(ns kyoninka.cells.social-post.state-machine
  "Phase state machine for the 許認可 — Robotaxi Legal-Deployment Permitting social_post cell — the publication membrane that
